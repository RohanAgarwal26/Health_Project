...
public class FragmentDetailsBindingImpl extends FragmentDetailsBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.detailsBtnBack, 1);
        sViewsWithIds.put(R.id.detailsImage, 2);
        sViewsWithIds.put(R.id.view, 3);
        sViewsWithIds.put(R.id.detailsTitleText, 4);
        sViewsWithIds.put(R.id.detailsBtnLike, 5);
        sViewsWithIds.put(R.id.detailsBtnShare, 6);
        sViewsWithIds.put(R.id.detailsBodyText, 7);
    }
    // views
    @NonNull
    ...
    private FragmentDetailsBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 0
            ...
            , (com.like.LikeButton) bindings[5]
